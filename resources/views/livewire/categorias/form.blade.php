...
<div class="row">
	<div class="col-sm-12">
		...
		<div class="input-group mb-3">
			...
			<input type="text" wire:model.lazy="name" class="form-control" placeholder="ej: Pañales Desechables">
		</div>
	...
	<div class="col-sm-12">
		...
		<div class="input-group mb-3">
			...
			<input type="text" wire:model.lazy="description" class="form-control"
                placeholder="ej: Pañales Desechables Diferentes Etapas del Crecimiento">
		</div>
